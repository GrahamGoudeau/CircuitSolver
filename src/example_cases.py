...
def main():
    ...
    circuit2.combine_junctions(j2, j3)
    ...
    circuit3.combine_junctions(j2, j3)
    ...
    circuit4.combine_junctions(j4, j1)
    ...
    circuit6.combine_junctions(j2, j3)
    circuit6.combine_junctions(j4, j5)
    ...
    circuit7.combine_junctions(j2, j3)
    circuit7.combine_junctions(j4, j5)
    circuit7.combine_junctions(j6, j7)
    ...
    circuit8.combine_junctions(j2, j3)
    ...
    circuit9.combine_junctions(j2, j3)
    circuit9.combine_junctions(j4, j5)
    ...
    circuit11.combine_junctions(j4, j1)
    ...
    circuit12.combine_junctions(j2, j3)
    ...
    circuit13.combine_junctions(j2, j3)
    circuit13.combine_junctions(j6, j7)
    circuit13.combine_junctions(j1, j5)
    circuit13.combine_junctions(j4, j8)
    ...
    circuit15.combine_junctions(j2, j3)
    ...
    circuit15.combine_junctions(j6, j1)
